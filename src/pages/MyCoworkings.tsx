        ...
        {coworkingData.map((coworking) => (
          ...
          >
            ...
            <button
              onClick={async () => {
              try {
                await apiClient.deleteCoworking(coworking.idsede.toString());
                // Optionally, you can refetch the coworkings list or update the state to remove the deleted coworking
