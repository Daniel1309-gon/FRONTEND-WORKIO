...
const EditUser = () => {
    ...
    const onSubmit = handleSubmit((data) => {
        ...
        if (data.firstName !== userFirstName) updatedData.firstName = data.firstName;
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className="flex p-5 gap-2">
                <label className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    {isPasswordModified && ( // Solo mostramos la barra si la contraseña fue modificada
                        <div className="mt-2">
                ...
                <label className="text-gray-700 text-sm font-bold flex-1">
                    ...
                    <input
                        ...
                        {...register("confirmPassword", {
                            validate: (val) =>
                                !isPasswordModified || val === watch("password") || "Las contraseñas no coinciden",
                        })} 
                    />
            ...
            <div className="flex items-center justify-center">
                <button 
                    ...
                    className={`bg-rose-400 text-white p-2 font-bold hover:bg-rose-500 text-xl ${
                        isPasswordModified && passwordStrength < 2 ? "opacity-50 cursor-not-allowed" : ""
                    }`}
